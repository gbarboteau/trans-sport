"""
Django settings for transsport_project project.
...
ALLOWED_HOSTS = ['.herokuapp.com', 'trans-sport.herokuapp.com']
...
WSGI_APPLICATION = 'transsport_project.wsgi.application'
...
STATICFILES_DIRS = (
    ...
    os.path.join(PROJECT_ROOT, 'static/application'),
)
