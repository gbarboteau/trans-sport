...
class IndexPageTestCase(TestCase):
    ...
    def setUp(self):
        ...
        test_place_1 = Place.objects.create(name='Bar à Chicha de Knuckles', description='Un max de plaisir fruité !', category=test_category_1, adress=test_adress_1, website='http://perdu.com' ,picture='https://lvdneng.rosselcdn.net/sites/default/files/dpistyles_v2/ena_16_9_extra_big/2020/03/06/node_721377/45623951/public/2020/03/06/B9722830880Z.1_20200306172512_000%2BG3MFLV4IR.1-0.jpg?itok=eZf4my0Q1583511920')
        ...
        test_place_2 = Place.objects.create(name='Kebab de Robotnik', description='Un max de plaisir non-fruité !', category=test_category_2, adress=test_adress_2, website='http://perdu.com' ,picture='https://lvdneng.rosselcdn.net/sites/default/files/dpistyles_v2/ena_16_9_extra_big/2020/03/06/node_721377/45623951/public/2020/03/06/B9722830880Z.1_20200306172512_000%2BG3MFLV4IR.1-0.jpg?itok=eZf4my0Q1583511920')
